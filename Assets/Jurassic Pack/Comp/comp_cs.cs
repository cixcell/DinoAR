...
public class comp_cs : MonoBehaviour
{
	...
	void FixedUpdate ()
	{
		...
		{
			//Moves
			if (Input.GetKey (KeyCode.JoystickButton4)) anim.SetInteger ("State", 2); //Jump
            ...
            else if (Input.GetAxis("Horizontal")!=0) anim.SetInteger ("State", 1); //Walk
            else if (Input.GetAxis("Vertical")!= 0) anim.SetInteger("State", 1); //Walk
			...
			//Attack
			if (Input.GetKey (KeyCode.JoystickButton3)) anim.SetBool ("Attack", true);
